...
class CreativesControllerTest < ActionController::TestCase
  ...
  test "should create creative" do
    assert_difference('Creative.count') do
      post :create, creative: { description: @creative.description, image: @creative.image, title: @creative.title, url: @creative.url }
    end
  ...
  test "should update creative" do
    put :update, id: @creative, creative: { description: @creative.description, image: @creative.image, title: @creative.title, url: @creative.url }
    assert_redirected_to creative_path(assigns(:creative))
  end
