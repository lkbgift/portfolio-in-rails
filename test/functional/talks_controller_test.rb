...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { date: @talk.date, description: @talk.description, event: @talk.event, image: @talk.image, location: @talk.location, title: @talk.title }
    end
  ...
  test "should update talk" do
    put :update, id: @talk, talk: { date: @talk.date, description: @talk.description, event: @talk.event, image: @talk.image, location: @talk.location, title: @talk.title }
    assert_redirected_to talk_path(assigns(:talk))
  end
